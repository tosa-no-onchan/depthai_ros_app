...
int main(int argc, char** argv){
    ...
    //badParams += !pnh.getParam("tf_prefix", tfPrefix);      //     <arg name="tf_prefix"             default="oak"             />
    //badParams += !pnh.getParam("camera_param_uri", camera_param_uri);       // <arg name="camera_param_uri"      default="package://depthai_examples/params/camera" />
